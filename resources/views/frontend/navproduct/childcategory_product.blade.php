...
<main class="main">
	<div class="page-header text-center" style="background-image: url('{{ asset('public/frontend')  }}/assets/images/page-header-bg.jpg')">
		<div class="container">
			<h1 class="page-title">{{ $childcatagory->childcategory_name }} </h1>
		</div><!-- End .container -->
	</div><!-- End .page-header -->
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">@isset( $getcategory->childcategory->childcategory_name ) {{ $getcategory->childcategory->childcategory_name }} @endisset</a></li>
            </ol>
        </div><!-- End .container -->
        			...
        			<div class="toolbox">
        				<div class="toolbox-left">
        					<div class="toolbox-info">
        						Showing <span>9 of {{ count($catProduct) }}</span> Products
										...
										@foreach($category as $row)
											...
											<div class="filter-item">
												<div class="custom-control custom-checkbox">
													<a href="{{ route('nav.categorywise.product', $row->id) }}" class="text-dark">{{ $row->category_name }}</a>
												</div>
											</div>
										@endforeach
