...
<main class="main">
	<div class="page-header text-center" style="background-image: url('{{ asset('public/frontend')  }}/assets/images/page-header-bg.jpg')">
		<div class="container">
			<h1 class="page-title">{{ $catagoris->category_name }} </h1>
		</div><!-- End .container -->
	</div><!-- End .page-header -->
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">@isset( $getcategory->category->category_name ) {{ $getcategory->category->category_name }} @endisset</a></li>
            </ol>
        </div><!-- End .container -->
										...
										@foreach($subcategory as $row)
											...
											<div class="filter-item">
												<div class="custom-control custom-checkbox">
													<a href="{{ route('subcategory.product', $row->id) }}" class="text-dark">{{ $row->subcategory_name }}</a>
												</div>
											</div>
										@endforeach
