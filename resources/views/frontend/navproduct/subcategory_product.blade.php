...
<main class="main">
	<div class="page-header text-center" style="background-image: url('{{ asset('public/frontend')  }}/assets/images/page-header-bg.jpg')">
		<div class="container">
			<h1 class="page-title">{{ $subcatagory->subcategory_name }} </h1>
		</div><!-- End .container -->
	</div><!-- End .page-header -->
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">@isset( $getsubcategory->subcategory->subcategory_name ) {{ $getsubcategory->subcategory->subcategory_name }} @endisset</a></li>
            </ol>
        </div><!-- End .container -->
        			...
        			<div class="toolbox">
        				<div class="toolbox-left">
        					<div class="toolbox-info">
        						Showing <span>9 of {{ count($subcatProduct) }}</span> Products
	                                ...
	                                <div class="product product-7 text-center">
	                                    <figure class="product-media">
	                                        ...
	                                        <div class="product-action">
	                                            <a href="{{ route('product.details', $row->slug) }}" class="btn-product btn-cart"><span>add to cart</span></a>
							...
							<div class="collapse show" id="widget-1">
								<div class="widget-body">
									<div class="filter-items filter-items-count">
										...
										@foreach($childcatagory as $row)

											<div class="filter-item">
												<div class="custom-control custom-checkbox">
													<a href="{{ route('childcategorywise.product', $row->id) }}" class="text-dark">{{ $row->childcategory_name }}</a>
												</div>
											</div>
										@endforeach
								...
								<div class="widget-body">
									<div class="filter-items filter-items-count">
										...
										@endphp
											...
											<div class="filter-item">
												<div class="custom-control custom-checkbox">
													<a href="" class="text-dark">{{ $row->brand_name }}</a>
												</div>
