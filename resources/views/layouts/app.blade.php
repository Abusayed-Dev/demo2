                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="widget widget-about">
                                <img src="{{ asset($setting->logo) }}" class="footer-logo" alt="Footer Logo" width="105" height="25">
                                ...
                                <div class="widget-about-info">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4">
                                            ...
                                            <a href="tel:123456789">+{{ $settings->phone_two }}</a>
                                        </div><!-- End .col-sm-6 -->
...
@endphp
                    <div class="social-icons social-icons-color">
                        ...
                        <a href="{{ $social->facebook }}" class="social-icon social-facebook" title="Facebook" target="_blank"><i class="icon-facebook-f"></i></a>
                        <a href="{{ $social->twitter }}" class="social-icon social-twitter" title="Twitter" target="_blank"><i class="icon-twitter"></i></a>
                        <a href="{{ $social->instagram }}" class="social-icon social-instagram" title="Instagram" target="_blank"><i class="icon-instagram"></i></a>
                        <a href="{{ $social->youtube }}" class="social-icon social-youtube" title="Youtube" target="_blank"><i class="icon-youtube"></i></a>
                        <a href="{{ $social->pinterest }}" class="social-icon social-pinterest" title="Pinterest" target="_blank"><i class="icon-pinterest"></i></a>
                    </div><!-- End .soial-icons -->
                </div><!-- End .container -->
    ...
    <div class="mobile-menu-container mobile-menu-light">
        <div class="mobile-menu-wrapper">
            ...
            <div class="social-icons">
                <a href="{{ $social->facebook }}" class="social-icon" target="_blank" title="Facebook"><i class="icon-facebook-f"></i></a>
                <a href="{{ $social->twitter }}" class="social-icon" target="_blank" title="Twitter"><i class="icon-twitter"></i></a>
                <a href="{{ $social->instagram }}" class="social-icon" target="_blank" title="Instagram"><i class="icon-instagram"></i></a>
                <a href="{{ $social->youtube }}" class="social-icon" target="_blank" title="Youtube"><i class="icon-youtube"></i></a>
                <a href="{{ $social->pinterest }}" class="social-icon" target="_blank" title="Pinterest"><i class="icon-pinterest"></i></a>
                        ...
                        <div class="form-tab">
                            ...
                            <div class="tab-content" id="tab-content-5">
                                <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-footer">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" name="remember" id="signin-remember" {{ old('remember') ? 'checked' : '' }}>
                                    ...
                                    <div class="pt-2">
                                        <p class="text-center">or sign in manualy</p>
                                        <div class="row">
                                            <div class="col-sm-6">
        ...
        function cart() {
            $.ajax({
                ...
                success: function (data) {
                    $('.cart_count').empty();
                    $('.cart_total').empty();
                    $('.cart_count').append(data.cart_qty);
